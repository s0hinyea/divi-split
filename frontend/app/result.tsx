...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: fonts.bodyBold, fontSize: 28 },
  headerSubtitle: {
  ...
  compactValue: { fontFamily: fonts.bodyBold, fontSize: fontSizes.md, color: colors.green },
  placeholderText: { color: colors.gray400 },
  itemsScroll: { flex: 1 },
  itemsContent: { paddingHorizontal: spacing.lg, paddingBottom: spacing.lg },
  ...
  itemPrice: { fontFamily: fonts.bodySemiBold, fontSize: fontSizes.md, color: colors.green },
  ...
  changeInput: { fontFamily: fonts.body, fontSize: fontSizes.md, color: colors.black },
  deleteAction: {
  ...
  totalLabel: { fontFamily: fonts.bodyBold, fontSize: fontSizes.lg, color: colors.black },
  totalAmount: { fontFamily: fonts.bodyBold, fontSize: fontSizes.xl, color: colors.green },
  footerButtons: { flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center' },
  footerButton: {
    width: 50, height: 50,
    justifyContent: 'center', alignItems: 'center',
  ...
  progressBarFill: { height: '100%', backgroundColor: colors.green, borderRadius: radii.full },
  modalOverlay: {
    flex: 1,
    justifyContent: 'center',
    alignItems: 'center',
  ...
  modalAddButtonText: { fontFamily: fonts.bodySemiBold, fontSize: fontSizes.md, color: colors.white },
});
