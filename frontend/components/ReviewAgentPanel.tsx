...
import type { AgentMessage } from "@/utils/useReviewAgent";
      ...
      <View style={styles.header}>
        <View style={styles.headerRow}>
          <View style={styles.statusIndicator}>
            ...
            <Text style={styles.headerTitle}>Review Assistant</Text>
          </View>
          {messages.length > 0 && (
            <TouchableOpacity
        ...
        <Text style={styles.headerSubtitle}>Edit your split with voice or text</Text>
      </View>
      ...
      >
        {messages.length === 0 && (
          <View style={styles.emptyState}>
            <MaterialIcons name="auto-awesome" size={36} color={colors.gray300} />
            <Text style={styles.emptyTitle}>Ready to review</Text>
            <Text style={styles.emptyHint}>
              {"Try:\n"}
              {'"Rename receipt to Dinner at Joe\'s"\n'}
              {'"Set the tip to $10"\n'}
              {'"Move the pasta to Sarah"\n'}
              {'"Send the summary"'}
            </Text>
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  loadingBubble: { paddingHorizontal: spacing.lg },
  bubbleText: {
    fontFamily: fonts.body,
    fontSize: fontSizes.md,
    lineHeight: 22,
